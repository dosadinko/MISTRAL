...
public class MistralApp {

    private static final Logger log = LoggerFactory.getLogger(MistralApp.class);

    private final Environment env;

    public MistralApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MistralApp.class);
